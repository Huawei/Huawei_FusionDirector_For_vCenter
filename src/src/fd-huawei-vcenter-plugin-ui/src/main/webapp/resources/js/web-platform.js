...
// This also creates the plugin's private namespace com_huawei_fdvcenterpluginui
//
...
if (!com_huawei_fdvcenterpluginui) {
   com_huawei_fdvcenterpluginui = {};

   // The web context path to use for server requests, compatible with Flex and HTML clients
   com_huawei_fdvcenterpluginui.webContextPath = WEB_PLATFORM.getRootPath() + "/fdvcenterpluginui";
   ...
   (function () {
      // Namespace shortcut
      var ns = com_huawei_fdvcenterpluginui;

      // ------------------------ Private functions -------------------------------

      // Get a string from the resource bundle defined in plugin.xml
      function getString(key, params) {
         return WEB_PLATFORM.getString("com_huawei_fdvcenterpluginui", key, params);
      }
      ...
      // Functions exported to the com_huawei_fdvcenterpluginui namespace
...
} // end of if (!com_huawei_fdvcenterpluginui)
